...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see net.novogrodsky.service.impl.PasswordTokenManager#generateRecoveryToken(net.novogrodsky.model.User)
     */
    @Override
    ...
    /**
     * @see net.novogrodsky.service.impl.PasswordTokenManager#isRecoveryTokenValid(net.novogrodsky.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see net.novogrodsky.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
