package net.novogrodsky.service.impl;

import org.apache.commons.lang.StringUtils;
import net.novogrodsky.dao.UserDao;
import net.novogrodsky.model.User;
import net.novogrodsky.service.MailEngine;
import net.novogrodsky.service.UserExistsException;
import net.novogrodsky.service.UserManager;
import net.novogrodsky.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "net.novogrodsky.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see net.novogrodsky.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
